...
def processar_encartes():
    ...
    for i in range(total):
        try:
            ...
            click_downloadbutton= driver.find_element(By.CSS_SELECTOR, 'class=[flipbook-icon-print flipbook-icon flipbook-menu-btn skin-color flipbook-color-light]')
            click_downloadbutton.click()
